...
const AutoBananaLogo: React.FC<{ className?: string }> = ({ className = "h-8 w-auto" }) => (
  <svg className={className} viewBox="0 0 1410.5 303.6" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <style>
        {`.st0 {
          fill: none;
    ...
    <g>
      <path className="st0" d="M102.7,48.9l-9.9-14.3-14.6,80.2c3.6,2.9,7.3,5.6,11.1,8.2l13.5-74Z"/>
      <path className="st0" d="M64,192.6l-7.9,43.2,14.3-9.9,4.7-25.7c-3.7-2.2-6.7-4.1-7.5-4.8,0,0-1.4-.9-3.6-2.7Z"/>
      <polygon className="st0" points="313.1 65.8 102.9 27.5 112.8 41.9 298.7 75.7 313.1 65.8"/>
      <path className="st0" d="M209.6,131.4c8.8-4.2,18.8-10.2,21.9-13.4,2.7-2.7,3.1-3.3,5.7-9.9,1.5-3.9,3.7-8.6,4.8-10.5,1.8-3.1,2.3-3.6,4.5-4.2,3.1-.8,4.9.1,12,6.2,9.2,7.9,10.8,10.5,8.7,14.1-.5.9-4.3,4.6-8.5,8.2-9.2,8.1-9.4,8.5-10.1,21-.9,15.8-3.1,23.9-10,35.9-2.4,4.1-5.8,9.3-7.9,11.7-7.7,9.3-19.4,18.1-31.5,23.7-6.7,3.1-29,9.3-35.3,9.8-1.9.2-17.3.4-31.5-1.8-13.8-2.1-26.6-6.6-26.6-6.6-7.9-3.2-12.8-5.5-19.4-9.1l-3.3,17.9,178.8,32.5,30.9-169.9L114.2,54.6l-13.7,75.3c16.1,9.2,28.9,13.2,46.1,14.5,20.6,1.5,41.6-2.8,63.1-13Z"/>
      <polygon className="st0" points="77.5 236.1 63.1 246 273.3 284.2 263.4 269.9 77.5 236.1"/>
      <polygon className="st0" points="273.5 262.9 283.4 277.3 320.1 75.9 305.7 85.8 273.5 262.9"/>
...
export const Header: React.FC = () => (
  <header className="bg-yellow-400 sticky top-0 z-20 border-b border-yellow-300" style={{ height: '64px' }}>
    <div className="h-full flex items-center justify-between" style={{ paddingLeft: '20px', paddingRight: '20px' }}>
      <AutoBananaLogo className="h-9 w-auto" />
